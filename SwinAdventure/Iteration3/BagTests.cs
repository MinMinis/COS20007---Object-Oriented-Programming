...
namespace Iteration3
{
    ...
    public class BagTests
    {
        ...
        public void Setup()
        {
            _bag1 = new(new string[] { "bag", "cloth" }, "big bag", "A bag can contain everything");
            _bag2 = new(new string[] { "bag2", "feather" }, "small bag", "A bag can contain small items");
            _item1 = new(new string[] { "sword", "bronze" }, "bronze sword", "Short range attack");
            _item2 = new(new string[] { "gun", "iron" }, "iron sword", "Long range attack");
        }
